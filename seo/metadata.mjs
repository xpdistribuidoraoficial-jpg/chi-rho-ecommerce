...
export const pages = {
  ...
  'politica-de-privacidade.html': { path: '/politica-de-privacidade.html', name: 'Política de Privacidade', title: 'Política de Privacidade | CHI RHO', description: 'Saiba como a CHI RHO trata dados pessoais, pedidos, autenticação e atendimento em conformidade com a LGPD.' },
  'termos-de-uso.html': { path: '/termos-de-uso.html', name: 'Termos de Uso', title: 'Termos de Uso | CHI RHO', description: 'Consulte as condições de uso, compra, pagamento, disponibilidade e atendimento da loja virtual CHI RHO.' },
  'trocas-e-devolucoes.html': { path: '/trocas-e-devolucoes.html', name: 'Trocas e Devoluções', title: 'Trocas e Devoluções | CHI RHO', description: 'Conheça as regras de arrependimento, troca, devolução e reembolso para compras realizadas na CHI RHO.' },
  'politica-de-entrega.html': { path: '/politica-de-entrega.html', name: 'Política de Entrega', title: 'Política de Entrega | CHI RHO', description: 'Consulte como funcionam frete, prazo, endereço, rastreamento e tentativas de entrega dos pedidos CHI RHO.' }
};
